...
/**
 * Aporte numa meta (modelo "cofrinho"): reserva dinheiro de uma conta
 * (o disponível dela cai). Não vale para cartão de crédito e nunca pode
 * passar do saldo disponível da conta de origem.
 */
